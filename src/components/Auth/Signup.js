...
class Signup extends Component {
  ...
  handleOnSubmit(e) {
    ...
    this.setState({ confirmError: 'Password and confirmPassword do not match.'})
    return null;
  }
  ...
  render() {
    ...
    return (
      <Modal
        className='auth'
        size='small'
        trigger={<Button color='olive' onClick={this.handleOnOpen}>Sign up</Button>}
      ...
      >
        ...
        <Modal.Content>
          <Form
            ...
            error={!!signUpError.email || !!signUpError.password || !!confirmError}
            >
            <Form.Field>
              <label>Email</label>
              <input
            ...
            <Form.Field>
              ...
              <Message
                ...
                content={(signUpError.password) ? signUpError.password.message : ''}
              />
            </Form.Field>
            <Form.Field>
